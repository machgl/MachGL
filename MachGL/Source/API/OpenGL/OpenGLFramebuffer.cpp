...
namespace MachGL {
    namespace Graphics {
        ...
        void OpenGLFramebuffer::switchColorDepth() {
        ...
        void OpenGLFramebuffer::generateRenderbuffer() {
        ...
        void OpenGLFramebuffer::textureParameters() {
        ...
        void OpenGLFramebuffer::generateDepthbuffer() {
        ...
        void OpenGLFramebuffer::capture() {
